...
<div class="max-w-7xl mx-auto py-6 px-4">
    ...
    <?php endif; ?>
        ...
        <?php else: ?>
            ...
            <!-- Optional: kasih info kenapa gak muncul -->
            <div class="bg-yellow-50 border border-yellow-200 text-yellow-700 p-4 rounded-lg mb-6 text-sm">
                Produk hanya bisa ditambahkan jika toko sudah <b>aktif</b>.
            </div>
